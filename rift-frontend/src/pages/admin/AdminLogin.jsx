...
function AdminLogin() {
  const { user, admin_login } = useContext(AuthContext);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const success = admin_login(formData.username, formData.password);
    if (success) {
  ...
  return (
    <div className="container mt-8">
      <BackButton />
      <h1 className="font-heading text-3xl mb-8 text-center">Admin Login</h1>
